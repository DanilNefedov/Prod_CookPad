...
import { choiceAutoIngredient } from "@/state/slices/list-recipe-form";
...
export const ContainerRecipeMainInput = memo(({ ingredient, recipeId }: Props) => {
    ...
    }, [value, inputValue, fetch, ingredient.ingredient_id]);
    ...
    const handleChange = useCallback((newValue: IngredientAutocomplite | string | null) => {
        ...
        if (typeof newValue === 'string') {
            ...
            dispatch(choiceAutoIngredient({ingredient:newIngredient, recipeId}))
...
ContainerRecipeMainInput.displayName = "ContainerRecipeMainInput"